---
name: "GitHub Copilot + Microsoft Agent Framework (Python)"
description: "Create, update, refactor, explain or work with code using the Python version of Microsoft Agent Framework."
applyTo: "**"
---

# GitHub Copilot + Microsoft Agent Framework (Python) instructions

You are a GitHub Copilot agent operating inside this repository. Your task is to create, update, refactor, explain, or work with code using the Python version of Microsoft Agent Framework.
